...
br_summ <- br %>% 
  ...
  left_join(thresholds, by = c("areaOfExpertise" = "aoe"))
  

  
```
# Specialist pricing over the past 12 months  
All figures are based on the day rates submitted for Specialist briefs between `r start_date` and `r (end_date - 1)` inclusive. Responses over $10,000 have been removed.  

## Summary figures for the past 12 months  
